## Que es un proyecto y su definición?
...
Un proyecto es una iniciativa o emprendimiento de carácter temporal destinado a crear un resultado único, o un servicio o un producto 
...
**Evaluaciones post**: Es una retro-alimentación de lo que sucedió.
...
**Descomposición**: es donde se divide un proyecto grande donde se dividen responsabilidades para llevar acabo el proyecto mayor.
...
- Son de resultado único, producto o servicio
...
**Objetivo**: El principal objetivo del estudio de mercado es la obtención de información para determinar los ingresos y costos del flujo de caja de un proyecto


**Características principales**: Demanda, Oferta, Precio, Comercialización
**Sub Características**:
1) Ratificar la existencia de una necesidad que requiere ser satisfecha en el mercado, o la posibilidad de mejorar un producto y/o servicio
2) Cuantificar el tamaño del mercado y, con ello, la cantidad de bienes y/o servicios a
producir en el proyecto.
3) Conocer los medios idóneos para comercializar dichos bienes y/o servicios.
4) Determinar si el bien y/o servicio a generar será o no aceptado por el mercado objetivo.

### Agentes del mercado que pueden influir en el proyecto

**Mercado proveedor**: Consiste en el estudio de las alternativas de obtención de materias primas necesarias para el desarrollo del bien y/o servicio del proyecto.

**Ejemplo**: Esto implica analizar sus costos, sustitutos, entre otros, dependiendo del tipo de material.

**Mercado distribuidor**:  Tiene relación con la entrega del producto de forma oportuna y en algunos tipos de proyectos tiene mayor relevancia que en otros,

**Ejemplo**: Tiene relación con la entrega del producto de forma oportuna y en algunos tipos de proyectos tiene mayor relevancia que en otros.

**Mercado consumidor**: El consumidor final del producto es el que toma la decisión de compra, por lo que es Importante estudiarlo.

**Ejemplo**: Esto tiene directa relación con el estudio de demanda de un producto.

**Mercado Competidor**: Se refiere tanto a la competencia directa, es decir, el mismo producto o uno similar, como a la indirecta, esto es, competencia con otros productos, ya sea por los proveedores o por los distribuidores existentes.
